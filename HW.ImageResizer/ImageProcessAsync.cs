...
{
    public class ImageProcessAsync
    {
        /// <summary>
        /// 清空目的目錄下的所有檔案與目錄
        /// </summary>
        ...
        public async Task ResizeImages(string sourcePath, string destPath, double scale)
        {
            ...
            {
                var task = Task.Run(() => this.ResizImage(filePath, destPath, scale));
                list.Add(task);
            }
        ...
        public void ResizImage (string filePath,string destPath, double scale)
        {
